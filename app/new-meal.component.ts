...
@Component({
  ...
  template: `
    ...
    <h3>Add Meal</h3>
      ...
      <input placeholder="number of calories" class="input-lg" #newCalories>
      <button (click)="addMeal(newName, newDescription, newCalories)" class="btn-success btn-lg log-button">Log</button>
    </div>
  `
})
